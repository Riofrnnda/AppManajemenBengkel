...
<style>
	...
	<center><h2>Bengkel Kami Siap Melayani</h2></center>
		<div class="columns">
		  <ul class="price">
		    <li class="header" style="background-color:#2980b9;"><span class="fa fa-dashboard">Troubleshoot problem</span></li>
		    <li class="grey">Deteksi Kerusakan</li>
		    <li class="red"><span class="red">Kerusakan Pada Mesin<span class="red"></li>
		    <li class="red"><span class="red">Kerusakan Pada Suku Cadang</span></li>
			<li class="red"><span class="red">Kerusakan Pada Body</span></li>
		    <li class="red"><span class="red"><b></b> Dan Lain-Lain</span></li>	
		...
		<div class="columns">
		  <ul class="price">
		    <li class="header" style="background-color:#2980b9;"><span class="fa fa-wrench"> Service Machine</span></li>
		...
		<footer class="text-center">BENGKEL MOTOR By <a href="https://facebook.com/zerokimochi">Maulana AR</a> Copyright &copy; 2019</footer>
	</div>
